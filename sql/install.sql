...
CREATE TABLE IF NOT EXISTS `hlstats_Events_Connects` (
  ...
  `eventTime_Disconnect` datetime NOT NULL default CURRENT_TIMESTAMP,
  PRIMARY KEY  (`id`),
  KEY `playerId` (`playerId`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `hlstats_HostGroups` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_bin AUTO_INCREMENT=1 ROW_FORMAT=DYNAMIC;
...
) ENGINE=MEMORY DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_bin ROW_FORMAT=DYNAMIC;

CREATE TABLE `hlstats_Maps_Counts` (
  `rowId` int(11) NOT NULL auto_increment,
  `game` varchar(32) character set utf8mb4 NOT NULL,
  `map` varchar(64) character set utf8mb4 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hlstats_Players_History` (
  `playerId` int(10) unsigned NOT NULL default '0',
  `eventTime` date NOT NULL default CURRENT_TIMESTAMP,
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_bin PACK_KEYS=0 ROW_FORMAT=DYNAMIC;
